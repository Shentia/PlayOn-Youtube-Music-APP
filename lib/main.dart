...
import 'package:Playon/Helpers/handle_native.dart';
import 'package:Playon/Helpers/import_export_playlist.dart';
import 'package:Playon/Helpers/logging.dart';
import 'package:Playon/Helpers/route_handler.dart';
import 'package:Playon/Screens/Common/routes.dart';
import 'package:Playon/Screens/Player/audioplayer.dart';
import 'package:Playon/constants/constants.dart';
import 'package:Playon/constants/languagecodes.dart';
import 'package:Playon/providers/audio_service_provider.dart';
import 'package:Playon/theme/app_theme.dart';
...
Future<void> main() async {
  ...
  if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
    await Hive.initFlutter('PlayOn/Database');
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/PlayOn/$boxName.hive');
      lockFile = File('$dirPath/PlayOn/$boxName.lock');
    }
    await dbFile.delete();
...
//     // );
//     // await HomeWidget.updateWidget(name: 'PlayOnMusicWidget');
//   }
// }
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    // HomeWidget.setAppGroupId('com.shadow.PlayOn');
